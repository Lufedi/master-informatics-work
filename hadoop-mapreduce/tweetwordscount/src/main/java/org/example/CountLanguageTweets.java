...
public class CountLanguageTweets {
    ...
    public static class TokenizerMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            String countryCode = getLanguage(line);
            word.set(countryCode);
            context.write(word, one);
        }

        private String getLanguage(String jsonText) {
            try {
                ...
                return Optional.of((String) user.get().get("lang")).orElse(NOT_FOUND);
            } catch (Exception e){
                return NOT_FOUND;
            }
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(CountLanguageTweets.class);
